...
$id = $_GET['id'];
$sql = "SELECT * FROM tb_clientes WHERE c_id = '$id'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE tb_clientes SET c_nome = '$nome', c_email = '$email', c_cel = '$cel', c_status = '$status' WHERE c_id = $id";
...
<body>
    <div class="container-global">
        ...
        <form class="formulario" action="cadastro-altera-cli.php" method="post">
